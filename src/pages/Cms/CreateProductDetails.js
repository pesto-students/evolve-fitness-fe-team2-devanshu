...
export default class CreateProductDetails extends Component {
  state = {
    name: "",
    description: "",
    featuredImageUrl: "",
  ...
  componentDidMount() {
    axios
      ...
      .then((res) => {
        console.log(JSON.parse(res.data.ProductData[0].price));
      })
      .catch((err) => {});
  }
  render() {
        ...
        <Form onSubmit={this.submitHandler}>
          ...
          <Form.Group>
            <Row>
              <Col>
                <Col>
                  <Form.Label className={classes.FormLable}>Country</Form.Label>
                  <Form.Control
                    type="text"
                    placeholder="Country"
                    name="country"
              ...
              <Col>
                <div style={{ padding: "12px", width: "100%", height: "auto" }}>
                  ...
                  <ol>
                    ...
                    <li>
                      Go to the directions, map, or Street View image you'd like
                      to embed.
                    </li>
